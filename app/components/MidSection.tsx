...
const MidSection = () => {
  ...
  return (
    <div className="w-auto bg-slate-100 flex flex-row justify-center overflow-hidden">
      <div
        ...
        return(
          <>
            ...
            <div className="flex flex-row whitespace-nowrap">
              ...
              <h3 className="text-xl py-2 px-5 font-bold text-slate-600">Experiense: <span className="text-blue-300">{m.experiense}</span> Year+</h3>
            </div>
          </>
        )
        })}
