...
//vancastro
    {id:"vancastro", category: "team", title: "Vancastro Driving School", description: "ファイナルプロジェクトで、私はプロジェクトマネージャー兼フルスタックエンジニアとして参加しました。プロジェクト内容は、カナダの自動車学校向けの生徒入会およびレッスン予約システムの開発です。外部の会計システムとの連携も実装し、技術選定からクライアントとのミーティングまで、すべての工程を経験しました。使用技術は、フロントエンドに Next.js、バックエンドに Node.js（Express）、データベースに PostgreSQL を採用しました。", link: "https://aiwordquiz", imageSrc: myportfolio, imageAlt: "zen-eats",     stacks: ["Next.js", "Node.js(Express)", "Typescript", "TailwindCSS", "Quickbook api", "schadcn-ui"], gitLink: "https://github.com/yuta-hamasaki/ai-quiz-app", videoLink: "https://www.youtube.com/embed/VojNti4rNhE" },
]